...
ggplot(data = fo_feb_flights, aes(x = arr_delay)) +
  geom_histogram()
fo_feb_flights %>%
...
fo_feb_flights %>%
    group_by(carrier) %>%
    summarise(IQR_arrd = IQR(arr_delay))
...
ggplot(data=nycflights, aes(x=avg_speed, distance)) + geom_point()
